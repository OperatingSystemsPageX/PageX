...
help:
	...
	@echo "  --tlb-entry <numero>         Número de entradas da TLB (default: sem TLB)"
	@echo "  --tlb-alg <algoritmo>        Algoritmo de substituição da TLB (default: sem TLB)"
	@echo "  --memoria-fisica <tamanho>   Tamanho da memória física em Bytes (default: igual ao espaco de enderecamento virtual, nesse caso não há eviction)"
